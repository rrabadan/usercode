...
class SiStripTrackerMapCreator {
 ...
 private:
  ...
  void paintTkMapFromHistogram(DQMStore* dqm_store, MonitorElement* me, std::string& map_type, /*bool doTopNmod,*/ std::vector<std::pair<float,uint32_t> >* topNmodVec);
  ...
  //void prueba(DQMStore* dqm_store, MonitorElement* me, std::string& htype, std::vector<std::pair<float,uint32_t> >* topNmodVec, bool doTopNmod );
