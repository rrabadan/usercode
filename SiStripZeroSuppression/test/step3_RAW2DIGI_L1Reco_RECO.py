...
# with command line options: step3 --filein file:RAW.root --fileout file:RECO.root --conditions auto:run1_mc --step RAW2DIGI,L1Reco,RECO -n 100 --eventcontent RECODEBUG --datatier GEN-SIM-RECO --scenario pp --no_exec
